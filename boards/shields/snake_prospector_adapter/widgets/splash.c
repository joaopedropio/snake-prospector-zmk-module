...
void print_splash(void) {
	...
	print_bitmap(buf_splash_snake, CHAR_S, 20 + 0, 80, snake_scale, get_splash_num_color(), get_splash_bg_color(), FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_N, 20 + 48, 80, snake_scale, get_splash_num_color(), get_splash_bg_color(), FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_A, 20 + 96, 80, snake_scale, get_splash_num_color(), get_splash_bg_color(), FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_K, 20 + 144, 80, snake_scale, get_splash_num_color(), get_splash_bg_color(), FONT_SIZE_4x6);
	print_bitmap(buf_splash_snake, CHAR_E, 20 + 192, 80, snake_scale, get_splash_num_color(), get_splash_bg_color(), FONT_SIZE_4x6);
}
