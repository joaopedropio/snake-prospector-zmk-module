...
void set_colors() {
    ...
    #ifdef CONFIG_SNAKE_USE_CUSTOM_COLORSCHEME

    uint32_t color1 = CONFIG_SNAKE_COLOR_1;
    uint32_t color2 = CONFIG_SNAKE_COLOR_2;
    uint32_t color3 = CONFIG_SNAKE_COLOR_3;
    uint32_t color4 = CONFIG_SNAKE_COLOR_4;
